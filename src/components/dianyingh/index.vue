<template>
  <div id="content">
    <div class="movie_menu">
      <router-link tag="div" to="/dianying/dianwei" class="city_name">
        <span>大连</span>
        <i class="iconfont icon-lower-triangle"></i>
      </router-link>
      <div class="hot_swtich">
        <router-link tag="div" to="/dianying/dianzheng" class="hot_item">正在热映</router-link>
        <router-link tag="div" to="/dianying/dianjijiang" class="hot_item">即将上映</router-link>
      </div>
      <router-link tag="div" to="/dianying/dianserch" class="search_entry">
